...
const FirmAdd = ({
  ...
  }, [setNameOfPage, getAll__FIRM, getOne__CONTRACT, id]);

  useLayoutEffect(() => {
    if (state__CONTRACT.one__CONTRACT) {
      // console.log(state__CONTRACT.one__CONTRACT);

      setFormData({
        number__Contract: state__CONTRACT.one__CONTRACT.number__Contract
          ? state__CONTRACT.one__CONTRACT.number__Contract
          : '',
        type_Contract: state__CONTRACT.one__CONTRACT.type_Contract
          ? state__CONTRACT.one__CONTRACT.type_Contract
          : '',
        typesOf_WorkInTheContract: state__CONTRACT.one__CONTRACT
          .typesOf_WorkInTheContract
          ? state__CONTRACT.one__CONTRACT.typesOf_WorkInTheContract
          : '',
        sum: state__CONTRACT.one__CONTRACT.sum
          ? state__CONTRACT.one__CONTRACT.sum
          : '',
        ourFirm: state__CONTRACT.one__CONTRACT.ourFirm
          ? state__CONTRACT.one__CONTRACT.ourFirm._id
          : '',
        client: state__CONTRACT.one__CONTRACT.client
          ? state__CONTRACT.one__CONTRACT.client._id
          : '',
      });

      setActive(state__CONTRACT.one__CONTRACT.active);
      set_date_Contract(state__CONTRACT.one__CONTRACT.date_Contract);
      set__searchOurFirm(
        state__CONTRACT.one__CONTRACT.ourFirm
          ? state__CONTRACT.one__CONTRACT.ourFirm.name__Firm
          : ''
      );
      set__searchClient(
        state__CONTRACT.one__CONTRACT.client
          ? state__CONTRACT.one__CONTRACT.client.name__Firm
          : ''
      );
    }
  }, [state__CONTRACT.one__CONTRACT]);
...
FirmAdd.propTypes = {
  ...
  getOne__CONTRACT: PropTypes.func.isRequired,
  update__CONTRACT: PropTypes.func.isRequired,
